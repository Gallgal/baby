...
const an1int = document.querySelector(".an1");
const an2 = document.querySelector(".an2");
const hel1 = document.querySelector(".hel1");
const hel2 = document.querySelector(".hel2");
const hel3 = document.querySelector(".hel3");
const hel4 = document.querySelector(".hel4");


function next(){
        hel2.style.display='block';
        setTimeout(function(){hel3.style.display = 'block'}, 3000);
};

function next2(){
hel4.style.display='block';
setTimeout(function s0f(){
hel1.style.display = 'none';
hel2.style.display = 'none';
hel3.style.display = 'none';
hel4.style.display = 'none';},4000);}


// intro ---------------------------------------------
var name = document.getElementById('nameint').value;
